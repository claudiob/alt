#!/bin/sh
# Every icon this gem shows anywhere is rendered from icon.svg, so the mark is drawn once
...
# mistake.
sed "s/rx='14'/rx='0'/" icon.svg > /tmp/alt-square.svg

png 180 apple-touch-icon.png /tmp/alt-square.svg
...
png 1024 avatar.png /tmp/alt-square.svg
...
for size in 16 32 48; do png "$size" "/tmp/alt-$size.png" icon.svg; done
magick /tmp/alt-16.png /tmp/alt-32.png /tmp/alt-48.png favicon.ico
